...
* Go to your Google Analytics dashboard. Under Home / Settings /Admin / Add a new property for your GitHub Page, generate your tracking id, and replace the analytics code with yours.  
